 ...
 * @author IOAdmin
 */
public class SimplexMethodForWord {
     ...
     */
    public SimplexMethodForWord(double[][] source, double freeMemberC) {
    ...
    private void iterations() throws Exception {
        ...
        while (!isItEnd()) {
            ...
            description += "Итерация " + (currentIter++) + "." 
                    + NEW_LINE
            ...
            description = "4. Пересчет симплекс-таблицы: "
